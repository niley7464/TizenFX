...
namespace Tizen.MachineLearning.Service
{
    ...
    public class Service : IDisposable
    {
        ...
        /// <summary>
        /// Creates new machine learning service from configuration file.
        /// </summary>
        ...
        internal Service(IntPtr handle)
        {
            ...
            _eventCallback = (type, event_data_handle, _) =>
            {
                if (type == EventType.NewData && EventReceived!= null) {
                    MlInformation info = new MlInformation(event_data_handle, MlInformation.InfoType.Information, false);
        ...
        /// <summary>
        /// Destroys the machine learning service instance.
        /// </summary>
        /// <since_tizen> 13 </since_tizen>
        ~Service()
        {
        ...
        /// <param name="name">The name of node in the pipeline. You can set empty string if serivce is constructed from model configuration.</param>
        /// <feature>http://tizen.org/feature/machine_learning.service</feature>
        /// <exception cref="ArgumentException">Thrown when the method failed due to an invalid parameter.</exception>
        /// <exception cref="NotSupportedException">Thrown when the feature is not supported.</exception>
        /// <since_tizen> 13 </since_tizen>
        ...
        /// <summary>
        /// The Query class connects to a remote device based on MlInformation.
        /// </summary>
        /// <since_tizen> 13 </since_tizen>
        public class Query : IDisposable
        {
            ...
            public TensorsData Request(TensorsData input)
            {
                ...
                IntPtr outputInfoPtr = IntPtr.Zero;
                ret = Interop.Util.GetInfo(outputPtr, out outputInfoPtr);
                MLService.CheckException(ret, "Failed to get output TensorsInfoHandle");

                return TensorsData.CreateFromNativeHandle(outputPtr, outputInfoPtr, true);
            }
            ...
            protected virtual void Dispose(bool disposing)
            {
                ...
                if (_service != null)
                {
                    MLServiceError ret = Interop.Service.Destroy(_service.GetHandle());
                    if (ret != MLServiceError.None)
                        Log.Error(MLService.TAG, "Failed to destroy the pipeline service handle");
        ...
        public class Model
        {
            ...
            static public void Activate(string name, int version)
            {
                ...
                if (version <= 0)
                    throw MLServiceExceptionFactory.CreateException(MLServiceError.InvalidParameter, "The property version is invalid");
            ...
            static public MlInformation Get(string name, int version)
            {
                ...
                MlInformation result = new MlInformation(info, MlInformation.InfoType.Information, false);
                return result;
            }
            ...
            /// </summary>
            /// <param name="name">The unique name to indicate the model.</param>
            /// <param name="version">The version of registered model. If version is 0, machine learning service will delete all information with given name.</param>
            /// <feature>http://tizen.org/feature/machine_learning.service</feature>
            /// <exception cref="ArgumentException">Thrown when the method failed due to an invalid parameter.</exception>
            /// <exception cref="NotSupportedException">Thrown when the feature is not supported.</exception>
            /// <since_tizen> 13 </since_tizen>
