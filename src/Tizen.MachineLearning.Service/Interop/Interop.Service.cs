...
internal static partial class Interop
{
    ...
    internal static partial class Service
    {
        ...
        internal static extern NNServiceError Create(string config, out IntPtr handle);
        ...
        internal static extern NNServiceError SetEventCb(IntPtr handle, ServiceEventCallback cb, IntPtr userData);
        ...
        internal static extern NNServiceError Start(IntPtr handle);
        ...
        internal static extern NNServiceError Stop(IntPtr handle);
        ...
        internal static extern NNServiceError GetInputInformation(IntPtr handle, string name, out IntPtr info);
        ...
        internal static extern NNServiceError GetOutputInformation(IntPtr handle, string name, out IntPtr info);
        ...
        internal static extern NNServiceError SetInformation(IntPtr handle, string name, string value);
        ...
        internal static extern NNServiceError GetInformation(IntPtr handle, string name, out IntPtr value);
        ...
        internal static extern NNServiceError Request(IntPtr handle, string name, IntPtr data);
        ...
        internal static extern NNServiceError Destroy(IntPtr handle);
        ...
        internal static extern NNServiceError SetPipeline(string name, string desc);
        ...
        internal static extern NNServiceError GetPipeline(string name, out IntPtr desc);
        ...
        internal static extern NNServiceError DeletePipeline(string name);
        ...
        internal static extern NNServiceError LaunchPipeline(string name, out IntPtr handle);
        ...
        internal static extern NNServiceError GetPipelineState(IntPtr handle, out int state);
        ...
        internal static extern NNServiceError CreateQuery(IntPtr option, out IntPtr handle);
        ...
        internal static extern NNServiceError RequestQuery(IntPtr handle, IntPtr input, out IntPtr output);
        ...
        internal static extern NNServiceError RegisterModel(string name, string path, bool activate, string description, out int version);
        ...
        internal static extern NNServiceError UpdateModelDescription(string name, int version, string description);
        ...
        internal static extern NNServiceError ActivateModel(string name, int version);
        ...
        internal static extern NNServiceError GetModel(string name, int version, out IntPtr info);
        ...
        internal static extern NNServiceError GetActivatedModel(string name, out IntPtr info);
        ...
        internal static extern NNServiceError GetAllModel(string name, out IntPtr info_list);
        ...
        internal static extern NNServiceError DeleteModel(string name, int version);
        ...
        internal static extern NNServiceError AddResource(string name, string path, string description);
        ...
        internal static extern NNServiceError DeleteResource(string name);
        ...
        internal static extern NNServiceError GetResource(string name, out IntPtr res);
    }
